...
exports.validateSignature = exports.generateSignature = exports.validatePassword = exports.encryptPassword = exports.generateSalt = void 0;
...
const validatePassword = (enteredPassword, savedPassword, salt) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield (0, exports.encryptPassword)(enteredPassword, salt)) === savedPassword;
});
